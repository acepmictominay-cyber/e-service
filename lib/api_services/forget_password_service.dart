...
Map<String, String> _registrationOtpCodes = {};
...
class ForgetPasswordService {
  ...
  static Future<Map<String, dynamic>> sendVerificationCodeByUsername(
    ...
    final customer = customers.firstWhere(
      (c) =>
          c['username'] == username &&
          (c['cos_hp'] == normalizedPhone || c['cos_hp'] == phone),
      orElse: () => null,
    );
    ...
    if (customer == null) {
      return {
        'success': false,
        'message': 'Username atau nomor HP tidak ditemukan'
      };
    }
    ...
    if (!finalPhoneNumber.startsWith('62')) {
      finalPhoneNumber =
          '62${finalPhoneNumber.startsWith('0') ? finalPhoneNumber.substring(1) : finalPhoneNumber}';
    }

    // Send WhatsApp message via Fonnte
    final message =
        'Kode verifikasi reset password Anda: $verificationCode\n\nGunakan kode ini untuk melanjutkan reset password.';
  ...
  static Future<Map<String, dynamic>> verifyCode(
      String customerId, String code) async {
